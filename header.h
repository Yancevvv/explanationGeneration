...
/*!
 * \brief Совершает прямой обход бинарного дерева со сбором данных в формате строк в вектор, а также добавляет союзы и предлоги, в зависимости от операции
...
/*!
 * \brief Производит сбор данных с узла в формате строки в вектор
...
/*!
 * \brief Формирует строку на русском языке, склоняя слова, в зависимости от предлогов или союзов
...
/*!
 * \brief Возвращает слово в заданном падеже
